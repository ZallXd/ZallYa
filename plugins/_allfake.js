...
global.kontak2 = [
[owner[0], await conn.getName(owner[0] + '6281236167286@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'cs@xflazzshop.com', true],
[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'cs@xflazzshop.com', true],
]
